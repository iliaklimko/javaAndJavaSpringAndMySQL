...
<div class="wrapper">
    ...
    <form  class="form-signin" action="/registration" method="post">
        <div>
            ...
            <input class="user-input form-control " type="text" name="username" id="inputUsername" placeholder="create a nickname" required autofocus  />
        </div>
        <div>
            <label class="user" for="text">
                <svg viewBox="0 0 32 32">
            ...
            <input class="user-input" type="text" name="email" id="name" placeholder="email" required autofocus  />
        </div>
        <div>
            ...
            <input type="password" name="password" id="name" placeholder="" required autofocus />
        </div>
        <div>
